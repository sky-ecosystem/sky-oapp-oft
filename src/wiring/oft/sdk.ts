...
import { accounts, setPeerConfig } from '../../../tasks/solana/sdk/oft302'
import {
    type OmniAddress,
...
export class OFT extends OmniSDK implements IOApp {
    ...
    async setOutboundRateLimit(
        ...
        throw new Error('setOutboundRateLimit not implemented')
    }
    ...
    async setInboundRateLimit(
        ...
        throw new Error('setInboundRateLimit not implemented')
    }
