...
if (!process.env.RPC_URL_SOLANA_TESTNET) {
    throw new Error("RPC_URL_SOLANA_TESTNET env required");
}
...
const connection = new Connection(process.env.RPC_URL_SOLANA_TESTNET);
