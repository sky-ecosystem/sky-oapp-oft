...
import { IOApp, OAppFactory, OAppOmniGraph } from '@layerzerolabs/ua-devtools'
...
export const createSdkFactory = (
    ...
    let solanaSdkFactory: OAppFactory<CustomOAppSDK> | OAppFactory<OFT>;
    if (isOApp) {
        solanaSdkFactory = createSimpleOAppFactory(
            // The first parameter to createOAppFactory is a user account factory
            //
        ...
        solanaSdkFactory = createOFTFactory(
