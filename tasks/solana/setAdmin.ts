...
task('lz:oft:solana:setAdmin', 'Set the admin for the OFT program')
    .addParam('admin', 'The admin address', undefined, devtoolsTypes.string)
    .addParam('fromEid', 'The source endpoint ID', undefined, devtoolsTypes.eid)
    .setAction(async (args: Args) => {
        const { admin, fromEid } = args
        ...
        console.log(`✅ Set admin for OFT program to ${admin}!`)
